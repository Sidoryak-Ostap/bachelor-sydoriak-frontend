    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-2">
          <h2 className="text-lg font-bold text-black">Fields Filter</h2>
          <button
        ...
        <div className="flex flex-col gap-3 mb-4">
          <h2 className="text-base font-bold text-black">Crop Type</h2>
        ...
        <div className="mb-4 pb-2 border-b-2 border-gray-200">
          <h3 className="text-base font-bold text-black mb-2">Size (ha)</h3>
          <Slider
          ...
          <div className="flex items-center justify-between">
            <p className="text-base text-gray-400">{sizeRange[0]} ha</p>
            <p className="text-base text-gray-400">{sizeRange[1]} ha</p>
          </div>
        </div>

        <div className="flex flex-col gap-3">
          <h2 className="text-base font-bold text-black">Soil Type</h2>

          <div className="grid grid-cols-4 gap-2">
            {SOIL_TYPES.map(soil => {
              const isSelected = selectedSoil.includes(soil);

              return (
                <button
                  onClick={() => handleToogleSoil(soil)}
                  key={soil}
                  className={`border rounded-lg py-2 text-sm font-medium transition-colors cursor-pointer 
                      ${
                        isSelected
